...
class PPNet(nn.Module):
    ...
    def __init__(self, features, img_size, prototype_shape,
                 proto_layer_rf_info, topk_k=1, num_classes=2, init_weights=True, last_layer_connection_weight=None,
    ...
    def forward(self, x):
        ...
        # x = x[:, 0, :, :]  #(no view; create slice. When no fa is available this will return x)
